...
(Really) Basic Physics
	...
	For each property that will change based on 'physics' you need an additional velocity property.
	Each update, add the velocity value to the corresponding property value.
	e.g.
